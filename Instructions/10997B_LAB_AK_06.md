...
5. In the Microsoft 365 admin center, if needed, click **Show more**, click  **Admin centers**, and then click  **SharePoint**.
...
9. On the left side, click  **sharing**.

10. Verify that  **Allow sharing to authenticated external users and using anonymous access links** is selected, and then click **OK**.
...
20. In the  **Enter a name** or **email address** box, type the email address of the Microsoft account you want to use. click the email address, and then click **Share**.
