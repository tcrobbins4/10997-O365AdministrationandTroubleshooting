...
5. In the Microsoft 365 admin center, if needed, click **Show all**, click  **Admin centers**, and then click  **SharePoint**. A new tab opens in Microsoft Edge.
...
13. In the  **select people** dialog box, click **Tenant**, in the  **Find** text box, type **Holly**, and then click  **search** (the magnifier icon). In the results, click the **Holly Spencer** row that has an email address, and then click **OK**.
...
15. On the menu bar beside  **Word Online**, click the **Beth Burke > Private** link to return to Microsoft OneDrive for Business.
...
2. In the  **Project A** folder, right-click **Project Targets.docx**, and then click  **Share**.

3. Notice that SharePoint Online automatically opens a dialog box named  **Send Link Project targets.docx**.

4. In the box at the top, type  **Holly Spencer**. Click on the Holly Spencer email address.
...
8. In the Office 365 portal, click  **Outlook**.
