...
6. From the Admin center, open the Teams admin center and select the Legacy portal.
...
3. In the Microsoft 365 admin center, edit  **Francisco Chaves**, and change the role to  **Billing administrator.**

4. In the Microsoft 365 admin center, edit  **Tameka Reed**, and change the role to  **Helpdesk administrator**.

5. In the Microsoft 365 admin center, edit  **Christie Thomas**, and change the role to  **User management administrator**.
