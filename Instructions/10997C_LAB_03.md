...
1. On the  **LON-DS1** computer, download and install latest version of Azure AD Connect by navigating to: https://www.microsoft.com/en-us/download/details.aspx?id=47594 
...
2. Sign in as  **Lindsey@Customdomainname.hostdomain.com**, where ***Customdomainname.hostdomain.com*** is your unique domain name, by using temporary password noted before. Update the password to a new password that meets the complexity requirements.
