...
2. In the  **Word** window, at the right-upper corner, click **Switch account** or **Sign in**.
...
3. In the app launcher, click the  **Admin** icon. Leave the Microsoft 365 portal open.

4. Open the new tab in Microsoft Edge and then browse to https://protection.office.com. If needed, sign in as Holly again.
...
24. Expand  **Search &amp; investigation** in left navigation pane.
...
1. In the navigation pane of Security & Compliance center, expand  **Data governance**, and then click  **Archive**.
...
3. In the  **Word** window, click  **Accept** **and start Word** and then at the right-upper corner, click **Switch account**. In the Accounts window, click **Add Account**.
...
3. In the  **Word** window, at the right-upper corner, click **Switch account**. 
