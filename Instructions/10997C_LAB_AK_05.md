...
1. On  **LON-CL1**, on the desktop, right-click  **Windows PowerShell**, and then click  **Run as administrator**.

2. In the  **User Account Control** dialog box, if it appears, click **Yes**.
...
12. In the  **Microsoft Microsoft 365 admin center**, on the navigation menu to the left, navigate to  **Admin centers**, click **Show all** and then click  **Teams**. 

13. In the left navigation menu, click **Legacy portal**. Skype for Business admin center will open in the new tab.

14. On the left-hand side in Skype for Business admin center, click  **organization**.
...
21. Expand **Meetings** and then click on **Meeting policies**. In the right menu, click **Add**.
...
10. On the  **First things first** page, if it appears, click **Ask me later**, and click  **Accept**.

11. In the  **Welcome - Skype for Business** window, if it appears, click **Skip for now**.

12. In the  **Microsoft Office Activation Wizard** dialog box,  if it appears, click **Close**.
...
14. After you signed in to Skype, you will get the message **Your organization is now using Microsoft Teams!**. Click **Go to Teams**.

15. In the **Teams** window, click **HS** icon at the top right corner, click **Settings** and then on **General** tab select option **Register Teams as the chat app for Office**. Close the **Settings** window.

20. Start **Outlook**. Click **File** menu, click **Options** and click **Add-Ins**. Click **Go...** at the bottom of the window.

21. In the COM Add-ins window, ensure that **Microsoft Teams Meeting Add-in for Microsoft Office** and **Skype Meeting Add-in for Microsoft Office** are both selected. If they are not, select both. Click **OK**.
...
4. In the Login to Microsoft Teams window, click **Sign in with another account** and then sign in as **Ada@Customdomainname.hostdomain.com**, where ***Customdomainname.hostdomain.com*** is your unique domain name, with password for Ada's account. Click **Sign in**. Ensure that you are not signing in as Ada@adatum.com.
...
14. Sign in as   **Ada@Customdomainname.hostdomain.com**, where ***Customdomainname.hostdomain.com*** is your unique domain name, with password for Ada's account, by using Ada's password.

15. On the  **Office 365** home page, click the **Outlook** tile.

16. Select the local time zone and then click  **Save**.

17. In the Outlook window, click Calendar icon, click the meeting scheduled for tomorrow, click  **Accept**, and then click  **Send the response now**.
