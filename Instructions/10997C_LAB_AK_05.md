...
12. In the  **Microsoft Microsoft 365 admin center**, on the navigation menu to the left, navigate to  **Admin centers**, and then click  **Teams**. 
...
22. Expand **Meetings** and then click on **Meeting policies**. In the right menu, click **Add**.
...
14. In the  **password** text box, type Holly's password, and then click  **Sign in**. Click  **Yes**.

15. In te **Teams** window, click **HS** icon at the top right corner, click **Settings** and then on **General** tab select option **Register Teams as the chat app for Office**. Close the **Settings** window.
