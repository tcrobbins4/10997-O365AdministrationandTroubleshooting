...
9. Click  **OK**.
10. On the left navigation pane of Sharepoint admin center, click  **Sharing**.
11. Verify that  **Anyone with the link** is selected, and then click **Save**.



#### Task 2: Configure user profiles

1. On the left navigation menu, click **Classic features** and then click  **Open** in the User profiles section.
...
1. Go back to the SharePoint admin center window, and on the **Classic features** page, click **Open** in the **Apps** section. On the **Apps** page, click  **Configure Store Settings**.
...
1. In Sharepoint admin center, on the left navigation menu, click **Classic features**.
2. On the Classic features page, expand **More classic features** and then click **Open** in  **Classic site collections page**.
...
26. Note that File Explorer displays the location where the synced files will be stored. Verify that the Word document has been synced to the local computer.
