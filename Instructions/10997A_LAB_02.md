...
9. Sign in as  **Christie@Adatum*yyxxxxx*.onmicrosoft.com** using the temporary password assigned earlier, where ***yyxxxxx*** is your unique Adatum number. Change the password to a new password.
