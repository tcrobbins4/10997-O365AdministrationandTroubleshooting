...
3. Run the following command to end your PowerShell session:
...
5. Sign in as  **Holly@Adatum*yyxxxxx*.onmicrosoft.com** by using Holly's password.

6. In the  **Teams and Skype admin center, in the Legacy Portal**, verify the following settings:
