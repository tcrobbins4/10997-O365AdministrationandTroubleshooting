...
3. In the app launcher, click the  **Admin** icon.
4. In the Microsoft 365 admin center, in the Admin centers section, click **Show all** and then click **Security & Compliance**. If needed, sign in as Holly again.
...
8. In the  **Choose Members** window, click **Add** select **Beth Burke**, click  **Add**, and then click  **Done**.
...
20. In Security & Compliance center, click  **eDiscovery Manager**.
...
27. Leave Microsoft Edge window with Security & Compliance center opened.
...
17. Close Windows PowerShell window.
