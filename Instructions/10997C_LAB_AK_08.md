...
3. In the app launcher, click the  **Admin** icon.
4. In the Microsoft 365 admin center, in the Admin centers section, click **Show all** and then click **Security & Compliance**. If needed, sign in as Holly again. **Note** : If Security & Compliance link is not available in the Admin centers list, open the new tab in the Microsoft Edge and navigate to the https://protection.office.com. Authenticate as Holly if needed.
