...
4. In  **Notepad**, remove all the remaining comment codes in the lines that start with:  "**&lt;!--**" and end with "**--&gt;**" (Note: leave the comment codes on the instructions paragraph at the top of the file, or delete it entirely.) 
...
16. On the  **Sign in** page, at [**https://portal.office.com**](https://portal.office.com), sign in as  **Abbi@Adatum*yyxxxxx*.onmicrosoft.com**, where ***yyxxxxx*** is your unique Adatum number, by using Abbi's password.
...
36. In the address bar, type  [**https://portal.office.com**](https://portal.office.com), and then press Enter.
...
17. In the address bar, type  [**https://portal.office.com**](https://portal.office.com), and then press Enter.
