...
9. Switch back to the Microsoft 365 Admin center and then, in the navigation pane, click  **Teams & Skype**.
...
13. Switch back to the Microsoft 365 Admin center and then, in the navigation pane, click  **SharePoint**.
...
2. Sign in as  **Tameka@Adatum*yyxxxxx*.onmicrosoft.com**;  where ***yyxxxxx*** is your unique Adatum number, by using the password assigned to Tameka's account. If prompted to stay signed in, click **No**.
...
19. In the  **Sign-in status** section, click **Edit**, click  **Sign-in blocked**, click  **Save**, and then click  **Close **twice.
