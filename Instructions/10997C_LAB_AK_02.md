...
1. 
2. On  **LON-CL1**, in the search box type **powershell**. In the Best match list, right click **Windows PowerShell (x86)** and then click **Run as administrator**.
...
6. In the **Manage admin roles** window, deselect **User(no administrator access)**, and then select  **Billing administrator** from the list, and click  **Save changes**, and then close the window.

7. In the list view, click  **Tameka Reed**.

8. On the  **Tameka Reed** page, in the Roles section, click **Manage roles**.

9. In the **Manage admin roles** window, deselect **User(no administrator access)**, and then select  **Help desk administrator** from the list, and click  **Save changes**, and then close the window.

10. In the list view, click  **Christie Thomas**.

13. On the  **Christie Thomas** page, in the Roles section, click **Manage roles**.

14. In the **Manage admin roles** window, deselect **User(no administrator access)**, and then select  **User management administrator** from the list, and click  **Save changes**, and then close the window.
...
7. Click  **Reset password** on the toolbar.
