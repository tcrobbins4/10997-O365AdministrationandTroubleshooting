...
6. Switch to Microsoft Edge, and then in the Exchange admin center, on **admin roles** tab, click  **Refresh**. Ensure that you can see the new  **Branch Office Admins** role group.

7. Double-click the  **Branch Office Admins** role.

8. In the  **Branch Office Admins** window, review the **Roles** section.
...
23. Note that the file does not open in preview, you can only download the file.

>  **Note:** In some cases, it may take a few minutes for the new Outlook Web App mailbox policy to take effect.

24. Click the Abbi Skinner icon at the right-upper and click **Sign out**. Close the InPrivate window.
...
10. In the  **Outlook** window, in the right-upper corner, click the **Ada Russell** icon, and then click  **Open another mailbox**.

11. In the  **Open another mailbox** window, type **Projects**, and then click  **Open**. Attempt to send an email to Holly from the Projects mailbox. You will receive an error message when you hit **Send**. Click **More details** and note the error. Leave this window open.
...
14. In the  **Projects** window, click **mailbox delegation**, and then in the  **Send As** section, verify that **Ada Russell** is not listed.

15. Click the  **+** icon.

16. In the list of users, select  **Ada Russell**, click  **add**, and then click  **OK**. Click  **Save**.

17. Switch back to the Microsoft Edge InPrivate window where you are signed in as  **Ada Russel**. Click **Send**. You should be able to successfully send the email now.

>  **Note:** You might need to wait for a few minutes.

18. In the  **Outlook** window, in the right-upper corner, click **Ada Russell**, and then click  **Sign out**.

19. Close the InPrivate window (all tabs).

20. In Microsoft Edge, click the Holly Spencer icon in the right-upper corner and then click **Sign out**. Close the Microsoft Edge window (all tabs).
