...
1. Click **Show all** in the navigation menu on the left and then expand **Health** and then click **Service health** to display the **Service health** dashboard.
...
4. In the Microsoft 365 admin center, in the left navigation menu, click **Show all** (if needed), click  **Settings**, and then click  **Services &amp; add-ins**.
