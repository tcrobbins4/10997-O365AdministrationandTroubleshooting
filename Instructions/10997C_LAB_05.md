...
5. In the  **Teams admin center**, open **Legacy Portal**, and verify the following settings:
...
9. Expand **Teams** and then click **Manage teams**.
10. Ensure that you see Adatum Projects team listed, and that the value in its **Privacy** column is set to **Private**.
11. Create new meeting policy. Name it **Adatum Teams meeting policy**. In this policy, allow transcription, reduce sharing to single application, and allow external participants to give or request control. Save the policy.
